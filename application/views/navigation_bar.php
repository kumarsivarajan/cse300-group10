...
<div id="navigationMenu" title="navigation">
 ...
 <li ><a class="about <?php if($navTab == "about"){echo " active";}?>" href="<?php echo site_url('Welcome/about'); ?>" title="About Page"><span>About the System</span></a></li>
  ...
  <li ><a class="about <?php if($navTab == "faq"){echo " active";}?>" href="<?php echo site_url('Welcome/faq'); ?>" title="FAQ"><span>FAQ</span></a></li>
  <li ><a class="portfolio <?php if($navTab == "policy"){echo " active";}?>" href="<?php echo site_url('Welcome/hostel_allocation_policy'); ?>" title="Policy"><span>Allocation Policy</span></a></li>
